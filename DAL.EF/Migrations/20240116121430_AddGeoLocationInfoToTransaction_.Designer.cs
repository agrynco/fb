...
namespace DAL.EF.Migrations
{
    ...
    [Migration("20240116121430_AddGeoLocationInfoToTransaction_")]
    partial class AddGeoLocationInfoToTransaction_
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DayTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LanguageId", "DayNumber")
                        .IsUnique();

                    b.HasIndex("LanguageId", "Value", "DayNumber");

                    b.ToTable("DayTranslations");
            ...
            modelBuilder.Entity("Domain.Finances.Account", b =>
                {
                    ...
                    b.HasIndex("Name", "OwnerId", "CurrencyId", "Type")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Finances.Transactions.Transaction", b =>
                {
                    ...
                    b.Property<int?>("GeoLocationPositionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GeoLocationPositionId");
            ...
            modelBuilder.Entity("Domain.GeoLocationPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.MonthTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LanguageId", "MonthNumber")
                        .IsUnique();

                    b.HasIndex("LanguageId", "Value", "MonthNumber");

                    b.ToTable("MothTranslations");
            ...
            modelBuilder.Entity("Domain.OutgoingEmailTemplate", b =>
                {
                    ...
                    b.ToTable("OutgoingEmailTemplates");
            ...
            modelBuilder.Entity("Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PasswordSalt = new byte[] { 203, 35, 198, 123, 209, 53, 124, 142, 67, 181, 18, 72, 108, 105, 132, 33 },
                            Username = "test"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Finances.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("Domain.FamilyMember", "FamilyMember")
                        .WithMany()
                        .HasForeignKey("FamilyMemberId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.GeoLocationPosition", "GeoLocationPosition")
                        .WithMany()
                        .HasForeignKey("GeoLocationPositionId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("GeoLocationPosition");
