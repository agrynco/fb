...
namespace DAL.EF.Migrations
{
    ...
    [Migration("20230601102107_ActualBalance2Balance")]
    partial class ActualBalance2Balance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Finances.Transactions.Transaction", b =>
                {
                    ...
                    b.Property<int?>("CorrelatedTransactionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CorrelatedTransactionId");
            ...
            modelBuilder.Entity("Domain.Finances.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("Domain.Finances.Transactions.Transaction", "CorrelatedTransaction")
                        .WithMany()
                        .HasForeignKey("CorrelatedTransactionId");
                    ...
                    b.Navigation("CorrelatedTransaction");
                });
